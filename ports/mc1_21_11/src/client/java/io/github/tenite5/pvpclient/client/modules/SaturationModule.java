...
public class SaturationModule extends Module {
	...
	public void render(GuiGraphics graphics, Player player, int y, int right) {
		if (!this.isEnabled()) {
			return;
		}
	...
	private static void drawSaturation(
		GuiGraphics graphics, int right, int y, float saturationLevel, float saturationGained, int color
	) {
	...
	private static void drawOutline(GuiGraphics graphics, int x, int y, String[] outline, int color) {
