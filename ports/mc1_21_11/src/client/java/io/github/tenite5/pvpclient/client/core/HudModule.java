...
public abstract class HudModule extends Module {
	...
	protected abstract void renderContent(GuiGraphics graphics, Minecraft minecraft);
	...
	protected void drawText(GuiGraphics graphics, Minecraft minecraft, String text, int x, int y) {
		graphics.drawString(minecraft.font, text, x, y, this.textColor.get(), this.textShadow.get());
	}
}
